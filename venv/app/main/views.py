...
def event_study(start_date, stop_date, price_change_low, price_change_high):
    ...
    print start_date
    print stop_date
    print price_change_low
    print price_change_high
...
def draw_fig(stocks, start_date, stop_date):
    ...
    p.line(ldt_timestamps, na_normalized_price)
